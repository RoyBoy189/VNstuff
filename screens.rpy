...
screen AddNote():
    fixed:
        textbutton "Add Note" action Function(NotesButton.create_note)
        #Function(NotesButton.CreateNote)

screen notebook():
    vbox xalign 1.0 yalign 1.0:
        textbutton "notebook" action ShowMenu("Notes")     
...
screen Notes():
    ...
    use game_menu(_("Notes"), scroll="viewport"):
        ...
        for j, x in zip(NotesButton.what, NotesButton.notes):
            window:
                
                vbox first_spacing 100:
                    yfit True
                    label x:
                        style "history_name"
                        substitute False
